                                ...
                                <div class="modal-body p-4">
                                    ...
                                    <form action="/edit-event/{{ $event->id }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    <label for="name" class="font-weight-bold text-primary">
                                                        <i class="mdi mdi-calendar-check"></i> Nama Acara
                                                    </label>
                                                    <input type="text" class="form-control border-primary" id="name" name="name" value="{{ $event->name }}" required placeholder="Masukkan nama acara">
                                                </div>
                                
                                                <div class="form-group mb-3">
                                                    <label for="start_date" class="font-weight-bold text-primary">
                                                        <i class="mdi mdi-calendar-range"></i> Tanggal Mulai
                                                    </label>
                                                    <input type="date" class="form-control border-primary" id="start_date" name="start_date" value="{{ \Carbon\Carbon::parse($event->start_date)->format('Y-m-d') }}" required>
                                                </div>
                                
                                                <div class="form-group mb-3">
                                                    <label for="end_date" class="font-weight-bold text-primary">
                                                        <i class="mdi mdi-calendar-end"></i> Tanggal Selesai
                                                    </label>
                                                    <input type="date" class="form-control border-primary" id="end_date" name="end_date" value="{{ \Carbon\Carbon::parse($event->end_date)->format('Y-m-d') }}" required>
                                                </div>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select class="form-control border-primary" id="sport_category" name="sport_category" required>
                                                        ...
                                                        @foreach ($sportCategories as $category)
                                                            <option value="{{ $category->id }}" {{ $event->sport_category == $category->id ? 'selected' : '' }}>
                                                ...
                                                <div class="form-group mb-3">
                                                    <label for="location" class="font-weight-bold text-primary">
                                                        <i class="mdi mdi-map-marker"></i> Lokasi
                                                    </label>
                                                    <input type="text" class="form-control border-primary" id="location" name="location" value="{{ $event->location }}" required placeholder="Masukkan lokasi acara">
                                                </div>
                                
                                                <div class="form-group mb-3">
                                                    <label for="location_map" class="font-weight-bold text-primary">
                                                        <i class="mdi mdi-map"></i> Peta Lokasi (iframe)
                                                    </label>
                                                    <textarea class="form-control border-primary" id="location_map" name="location_map" rows="3" required placeholder="Masukkan kode iframe dari Google Maps">{{ $event->location_map }}</textarea>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    <label for="banner" class="font-weight-bold text-primary">
                                                        <i class="mdi mdi-image"></i> Banner
                                                    </label>
                                                    <div class="mb-3">
                                                        @if ($event->banner)
                                                            <img src="{{ asset($event->banner) }}" alt="Current Banner" class="img-fluid rounded shadow-sm mb-2" style="max-width: 100%; height: auto;">
                                                        @else
                                                    ...
                                                    <small class="form-text text-muted">
                                                        Upload file gambar baru (format: JPG, PNG, JPEG. Ukuran maksimum: 2MB). Jika diunggah, banner lama akan diganti.
                                                    </small>
                                                </div>
                                            </div>
                                        </div>
