                                                        ...
                                                        <div
                                                            ...
                                                            <div class="card-body d-flex flex-column">
                                                                ...
                                                                <p class="card-text text-muted mb-2"
                                                                    ...
                                                                    <i class="mdi mdi-calendar me-1 text-warning"></i>
                                                                    {{ \Carbon\Carbon::parse($berita->tanggal_waktu)->format('d-m-Y H:i') }}
                                                                </p>
                                                                <p class="card-text mb-2 text-dark text-justify">
                                                                    {{ Str::limit(strip_tags($berita->isi_berita), 100) }}
                                                                </p>
                                                                <p class="card-text mb-2 text-dark">
                                                                    <i class="mdi mdi-map-marker-outline me-1 text-warning"></i>
                                                                    <strong>Lokasi:</strong>
                                                                    {{ $berita->lokasi_peristiwa }}
                                                                </p>
                                                                <p class="card-text mb-3 text-dark">
                                                                    <i class="mdi mdi-bookmark-outline me-1 text-warning"></i>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-7">
                                                                            ...
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <div
                                                                                    class="bg-light p-3 rounded shadow-sm text-dark">
                                                                                    {!! $berita->isi_berita !!}
                                                                                </div>
                                                                            </div>
