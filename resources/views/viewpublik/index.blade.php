...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .icon-container .mdi {
                font-size: 2rem;
                /* Perkecil ikon untuk layar kecil */
            }
...
<body>
    ...
    <section class="py-5 bg-light position-relative" id="about-section"
        style="background-image: url('https://images.vexels.com/media/users/3/297088/raw/3ff1701de8a5291ad893656da9bfaf18-running-sports-pattern-design.jpg'); 
           background-size: cover; 
        ...
        <div class="container text-center text-white position-relative z-2">
            <!-- Title and Subtitle -->
            <h2 class="fw-bold mb-4 text-white" data-aos="fade-up" style="letter-spacing: 1.5px;">KONI Sukoharjo</h2>
            <p class="mb-5 mx-auto" style="max-width: 800px;" data-aos="fade-up" data-aos-delay="100">
                KONI (Komite Olahraga Nasional Indonesia) Sukoharjo bertanggung jawab untuk mengkoordinasikan kegiatan
                olahraga,
                membina atlet, dan mendukung perkembangan olahraga di Kabupaten Sukoharjo.
            </p>
            ...
            <div class="row gy-4">
                ...
                <div class="col-6 col-md-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="card border-0 shadow-lg text-center p-4 h-100 card-hover bg-white"
                        onclick="window.location.href='/olahraga/cabor'">
                        <div class="icon-container mb-3" style="color: #FF9800;">
                            <i class="mdi mdi-basketball display-4"></i>
                        </div>
                        <h5 class="fw-bold" style="color: #FF9800;">Cabor</h5>
                        <p class="text-muted mb-3">Informasi lengkap tentang cabang olahraga yang dikelola KONI
                            Sukoharjo.</p>
                        <a href="/olahraga/cabor" class="btn btn-sm btn-primary tombol"
                            style="background-color: #FF9800; border-color: #FF9800;">Lihat Selengkapnya</a>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="card border-0 shadow-lg text-center p-4 h-100 card-hover bg-white"
                        ...
                        <div class="icon-container mb-3" style="color: #009688;">
                            <i class="mdi mdi-account-outline display-4"></i>
                        </div>
                        <h5 class="fw-bold" style="color: #009688;">Atlet</h5>
                        <p class="text-muted mb-3">Daftar atlet berbakat yang mewakili Sukoharjo di berbagai kompetisi.
                        </p>
                        <a href="/olahraga/atlet" class="btn btn-sm btn-primary tombol"
                            style="background-color: #009688; border-color: #009688;">Lihat Selengkapnya</a>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-4" data-aos="fade-up" data-aos-delay="300">
                    <div class="card border-0 shadow-lg text-center p-4 h-100 card-hover bg-white"
                        ...
                        <div class="icon-container mb-3" style="color: #3f51b5;">
                            <i class="mdi mdi-account-multiple-outline display-4"></i>
                        </div>
                        <h5 class="fw-bold" style="color: #3f51b5;">Pelatih</h5>
                        <p class="text-muted mb-3">Profil pelatih yang mendukung perkembangan atlet
                            Sukoharjo.</p>
                        <a href="/olahraga/pelatih" class="btn btn-sm btn-primary tombol"
                            style="background-color: #3f51b5; border-color: #3f51b5;">Lihat Selengkapnya</a>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-4" data-aos="fade-up" data-aos-delay="400">
                    <div class="card border-0 shadow-lg text-center p-4 h-100 card-hover bg-white"
                        ...
                        <div class="icon-container mb-3" style="color: #ff5722;">
                            <i class="mdi mdi-newspaper display-4"></i>
                        </div>
                        <h5 class="fw-bold" style="color: #ff5722;">Berita Terkini</h5>
                        <p class="text-muted mb-3">Berita dan informasi terkini seputar dunia olahraga di Sukoharjo.
                        </p>
                        <a href="/berita" class="btn btn-sm btn-primary tombol"
                            style="background-color: #ff5722; border-color: #ff5722;">Lihat Selengkapnya</a>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-4" data-aos="fade-up" data-aos-delay="500">
                    <div class="card border-0 shadow-lg text-center p-4 h-100 card-hover bg-white"
                        ...
                        <div class="icon-container mb-3" style="color: #e91e63;">
                            <i class="mdi mdi-trophy-outline display-4"></i>
                        </div>
                        <h5 class="fw-bold" style="color: #e91e63;">Prestasi Atlet</h5>
                        <p class="text-muted mb-3">Prestasi membanggakan dari atlet Sukoharjo di berbagai kompetisi.
                        </p>
                        <a href="/galeri/prestasi" class="btn btn-sm btn-primary tombol"
                            style="background-color: #e91e63; border-color: #e91e63;">Lihat Selengkapnya</a>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-4" data-aos="fade-up" data-aos-delay="600">
                    <div class="card border-0 shadow-lg text-center p-4 h-100 card-hover bg-white"
                        onclick="window.location.href='/galeri/calender'">
                        <div class="icon-container mb-3" style="color: #607d8b;">
                            <i class="mdi mdi-calendar display-4"></i>
                        </div>
                        <h5 class="fw-bold" style="color: #607d8b;">Kalender</h5>
                        <p class="text-muted mb-3">Jadwal kegiatan olahraga yang menampilkan event dan jadwal latihan.
                        </p>
                        <a href="/galeri/calender" class="btn btn-sm btn-primary tombol"
                            style="background-color: #607d8b; border-color: #607d8b;">Lihat Selengkapnya</a>
                    </div>
                </div>
            </div>
