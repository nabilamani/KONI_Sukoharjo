...
<nav class="navbar navbar-expand-lg shadow-sm">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center" href="#">
            <img src="{{ asset('gambar_aset/images/koni.png') }}" alt="KONI Sukoharjo"
                style="height: 50px; border-radius: 50px;" class="me-3">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <!-- Social Media Icons wrapped in bg-primary -->
                <li class="nav-item">
                    <div class="d-flex bg-primary rounded-5 ms-3 px-3 justify-content-around">
                        <a class="nav-link text-white" href="https://www.instagram.com/m_nabilamani/" target="_blank">
                            <i class="mdi mdi-instagram sosmed"></i>
                        </a>
                        <a class="nav-link text-white" href="https://wa.me/081227960337" target="_blank">
                            <i class="mdi mdi-whatsapp sosmed"></i>
                        </a>
                        <a class="nav-link text-white" href="https://www.facebook.com/KONIofficial/" target="_blank">
                            <i class="mdi mdi-facebook sosmed"></i>
                        </a>
                    </div>
                </li>
            </ul>
