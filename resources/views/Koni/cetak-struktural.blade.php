                ...
                <div class="row">
                    <div class="col-12">
                        @forelse ($strukturals as $struktur)
                            <div class="card shadow-sm border-0 rounded-4">
                                ...
                                <div class="card-footer text-center">
                                    ...
                                    <button class="btn btn-warning text-white me-2" data-bs-toggle="modal"
                                        data-bs-target="#editModal{{ $struktur->id }}">
                            ...
                            <!-- Edit Modal -->
                            <div class="modal fade" id="editModal{{ $struktur->id }}" tabindex="-1"
                                aria-labelledby="editModalLabel{{ $struktur->id }}" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="editModalLabel{{ $struktur->id }}">Edit
                                                Struktural KONI</h5>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="period"
                                                        name="period" value="{{ $struktur->period }}" required>
                                                </div>
