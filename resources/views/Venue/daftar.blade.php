                                                        ...
                                                        <form action="/edit-venue/{{ $venue->id }}" method="POST">
                                                            ...
                                                            <div class="form-group mb-3">
                                                                <label for="name" class="text-primary font-weight-bold">
                                                                    <i class="mdi mdi-map-marker-radius"></i> Nama Tempat
                                                                </label>
                                                                <input type="text" class="form-control border-primary" id="name" name="name"
                                                                       value="{{ $venue->name }}" required placeholder="Masukkan nama tempat">
                                                            </div>
                                                    
                                                            <div class="form-group mb-3">
                                                                <label for="address" class="text-primary font-weight-bold">
                                                                    <i class="mdi mdi-home-map-marker"></i> Alamat
                                                                </label>
                                                                <textarea class="form-control border-primary" id="address" name="address" required
                                                                          placeholder="Masukkan alamat tempat">{{ $venue->address }}</textarea>
                                                            </div>
                                                    
                                                            <div class="form-group mb-3">
                                                                <label for="sport_category" class="text-primary font-weight-bold">
                                                                    <i class="mdi mdi-soccer"></i> Kategori Olahraga
                                                                </label>
                                                                <select id="sportCategorySelect" name="sport_category" class="form-control sport-category-select border-primary">
                                                                    <option value="{{ $venue->sport_category }}" selected>{{ $venue->sport_category }}</option>
                                                                </select>
                                                            </div>
                                                    
                                                            <div class="form-group mb-3">
                                                                <label for="map" class="text-primary font-weight-bold">
                                                                    <i class="mdi mdi-map"></i> Peta (iframe)
                                                                </label>
                                                                <textarea class="form-control border-primary" id="map" name="map" required
                                                                          placeholder="Masukkan kode iframe peta">{{ $venue->map }}</textarea>
                                                            </div>
